    ...
    <Grid container justifyContent="center">
      ...
      >
        <TabContext value={value}>
          <TabList onChange={handleChange} aria-label="my-policy tabs">
            <Tab value="info" label="Policies Information" />
            <Tab value="rider" label="Rider" />
            <Tab value="history-payment" label="History Payment" />

            <Tab value="beneficiary" label="Beneficiary" />

            <Tab value="service-agent" label="Service Agent" />
          </TabList>
