    ...
    public static class DbInitializer
    {
        ...
        private static async Task GenerateDefaultRoles(RoleManager<Role> roleManager, InsuranceDbContext context)
        {
            ...
            await new RoleBuilder(roleManager)
                ...
                .WithCanCreateOwn(PermissionTarget.News)
                .WithCanUpdateOwn(PermissionTarget.News)
                .WithCanDeleteOwn(PermissionTarget.News)
                .Build();
        ...
        private static async Task GenerateDefaultUsers(UserManager<User> userManager)
        {
            ...
            {
                (new UserBuilder().WithEmail("chungtv@gmail.com").WithUsername("chungtv").Build(), "123456Aa@"),
                (new UserBuilder().WithEmail("admin@gmail.com").WithUsername("admin")
                    .WithDescription("I'm admin").Build(), "adminAa@")
            };
