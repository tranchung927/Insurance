...
namespace Server.Models.Builders.Specifications.Tag
{
    /// <summary>
    ...
    public class TagQueryFilter
    {
        ...
        /// </summary>
        /// <returns></returns>
        public FilterSpecification<Data.Tag> Build()
        {
            FilterSpecification<Data.Tag> filter = null;

            if (_inName != null)
                filter = new NameContainsSpecification<Data.Tag>(_inName);
