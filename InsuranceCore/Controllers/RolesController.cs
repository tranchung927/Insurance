...
using InsuranceCore.Models.Builders.Specifications.Role;
...
namespace InsuranceCore.Controllers
{
    ...
    public class RolesController : ControllerBase
    {
        ...
        [HttpGet]
        [AllowAnonymous]
        [ProducesResponseType(typeof(PageInsuranceResponse<GetRoleDto>), StatusCodes.Status200OK)]
        public async Task<IActionResult> GetRoles([FromQuery] GetRoleQueryParameters parameters)
        {
            ...
            return Ok(new PageInsuranceResponse<GetRoleDto>(data, pagingSpecificationBuilder.Page, pagingSpecificationBuilder.Limit,
