...
namespace InsuranceCore.Models.Builders.Specifications.Category
{
    /// <summary>
    ...
    public class CategorySortSpecificationBuilder
    {
        ...
        /// </summary>
        /// <returns></returns>
        public SortSpecification<Data.Category> Build()
        {

            var sort = _sort switch
            {
                CategorySort.Posts => new SortSpecification<Data.Category>(
                    new OrderBySpecification<Data.Category>(x => x.Posts.Count),
                    _order == Order.Desc
                        ? SortingDirectionSpecification.Descending
                        : SortingDirectionSpecification.Ascending),
                CategorySort.Name => new SortSpecification<Data.Category>(
                    new OrderBySpecification<Data.Category>(x => x.Name),
                    _order == Order.Desc
                        ? SortingDirectionSpecification.Descending
                        : SortingDirectionSpecification.Ascending),
                _ => new SortSpecification<Data.Category>(
                    new OrderBySpecification<Data.Category>(x => x.Name),
                    _order == Order.Desc
                        ? SortingDirectionSpecification.Descending
                        : SortingDirectionSpecification.Ascending)
