    ...
    public partial class CreateInitialDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HouseSizes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserDescription = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    RegisteredAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false, defaultValueSql: "SYSDATETIMEOFFSET()"),
                    LastLogin = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false, defaultValueSql: "SYSDATETIMEOFFSET()"),
                    RefreshToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RefreshTokenExpiration = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "HouseCoefficients",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HouseTypeId = table.Column<int>(type: "int", nullable: false),
                    HouseSizeId = table.Column<int>(type: "int", nullable: false),
                    Coefficient = table.Column<float>(type: "real", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HouseCoefficients", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HouseCoefficients_HouseSizes_HouseSizeId",
                        column: x => x.HouseSizeId,
                        principalTable: "HouseSizes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HouseCoefficients_HouseTypes_HouseTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublishedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false, defaultValueSql: "SYSDATETIMEOFFSET()"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleProperties_VehicleTypes_VehicleTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HouseCoefficients_HouseSizeId",
                table: "HouseCoefficients",
                column: "HouseSizeId");

            migrationBuilder.CreateIndex(
                name: "IX_HouseCoefficients_HouseTypeId",
                table: "HouseCoefficients",
                column: "HouseTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleProperties_VehicleTypeId",
